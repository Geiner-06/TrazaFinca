    ...
    return (
        <div className={`animal-card ${animal.estado === 'baja' ? 'baja' : ''}`}>
            ...
            <div className="card-details">
                <div className="card-detail-item"><span className="label">Raza</span><span className="value">{animal.raza || 'No esp.'}</span></div>
                <div className="card-detail-item"><span className="label">Sexo</span><span className="value">{animal.sexo}</span></div>
            </div>
